...
from training.DiffusionActor import DiffusionActor 
from rlkit.algo.diff_ql import Diffusion_QL
...
def experiment(variant):
    ...
    # DiffQL params
    diffql_params = variant["diffql_params"]
    diffql_net_size = diffql_params["net_size"]
    diffql_num_hidden = diffql_params["num_hidden_layers"]
    qf1 = FlattenMLP(
        input_dim=obs_dim + action_dim,
        output_dim=1,
        hidden_dims=diffql_num_hidden * [diffql_net_size],
    )
    qf2 = FlattenMLP(
        input_dim=obs_dim + action_dim,
        output_dim=1,
    ...
    policy.qf1 = agent_trainer.target_qf1
    policy.qf2 = agent_trainer.target_qf2
