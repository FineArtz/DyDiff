...
from rlkit.algo.td3_bc import TD3_BC
...
def experiment(variant):
    ...
    # TD3_BC params
    td3_bc_params = variant["td3_bc_params"]
    td3_bc_net_size = td3_bc_params["net_size"]
    td3_bc_num_hidden = td3_bc_params["num_hidden_layers"]
    qf1 = FlattenMLP(
        input_dim=obs_dim + action_dim,
        output_dim=1,
        hidden_dims=td3_bc_num_hidden * [td3_bc_net_size],
    )
    qf2 = FlattenMLP(
        input_dim=obs_dim + action_dim,
        output_dim=1,
